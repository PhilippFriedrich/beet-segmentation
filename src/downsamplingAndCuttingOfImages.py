...
def crop_and_resize_image(input_path, output_folder):
    ...
    # Überprüfe die Orientierung des Bildes und drehe es gegebenenfalls
    ...
    for y in range(0, target_height - square_size + 1, square_size):
        for x in range(0, target_width - square_size + 1, square_size):
            ...
            output_path = os.path.join(output_folder,
                                       f"{os.path.splitext(os.path.basename(input_path))[0]}_{y // square_size * (target_width // square_size) + x // square_size}.jpg")
...
print("Die Bilder wurden zugeschnitten, verkleinert und orientiert.")
