...
We provided the example area of interest inside the data section of this project (see [here](data/study_area/sb_field_1_area.geojson)). The orthophoto is too large to store on GitHub, you can download it [here](https://drive.google.com/drive/folders/1UtlULc3KyPyY-jFT2XceEdCMHTSHn0_c?usp=sharing). 
